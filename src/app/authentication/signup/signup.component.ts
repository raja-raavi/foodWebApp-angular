...
export class SignupComponent {
  ...
  constructor(private formBuilder: FormBuilder, private regUsersService: RegisteredUsersDataService, private router: Router){
  ...
  signupForm = this.formBuilder.group({
    ...
    email: [null, [Validators.required, this.testingEmail], this.testDuplicateEmail.bind(this)],
